// INGRESAR ANOTACIONES AL RVM CASO1 //
...
// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_ingresar_antecedentes_anotaciones_rvm/ingresar_antecedentes_anotaciones_RVM_script_caso1/evidencia_1',  currentDateTime, 
...
driver.findElement(By.xpath("//div[contains(text(),'XT0237')]"), 5000, 'No se encontró ppu.');
driver.sleep(2000);

// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_ingresar_antecedentes_anotaciones_rvm/ingresar_antecedentes_anotaciones_RVM_script_caso1/evidencia_2',  currentDateTime, 
'Error en screenshot para página de Login.'));
