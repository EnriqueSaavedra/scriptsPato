// SCRIPT CASO 4 INGRESO_DE_CONTRATOS_Y_ANEXOS CASO4 //
...
// Inicio del Test
//var currentDateTime = helpers.getCurrentDateTime();
//console.log('Iniciando la ejecución del test en fecha: ' + currentDateTime + ' Ejecución: ingreso_de_contratos_y_anexos_script_caso4');
...
driver.sleep(3000);
driver.findElement(By.css('#anexo-file-file')).sendKeys(datos[4].contrato);
driver.findElement(By.xpath("//button[contains(.,'Subir Anexo')]")).click();
driver.sleep(10000);

// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_ingreso_de_contratos_y_anexos/ingreso_de_contratos_y_anexos_script_caso4/evidencia_1',  currentDateTime, 
