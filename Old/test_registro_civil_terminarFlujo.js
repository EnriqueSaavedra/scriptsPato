...
//driver.findElement(By.id('contrato-file-file')).click(); ESTA LINEA NO IRIA
//driver.findElement(By.id("contrato-file")).sendKeys('C:\\Users\\PRG19HP\\Desktop\\RegistroRechazoDteWeb.pdf');

driver.findElement(By.id('contrato-file')).clear();
driver.findElement(By.id('contrato-file')).sendKeys('C:\\Users\\PRG19HP\\Desktop\\SRPSDManualdeUsuarioOficinasdeAtencionIntegral13.pdf') // Campo de seleccion de archivo (usando ruta local absoluta)
driver.sleep(3000);
driver.findElement(By.id('ext-gen199')).click();  // Botón de envío de formulario
