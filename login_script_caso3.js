...
// Campo Password
helpers.getVisibleElementWaiting(driver, By.id('pass'), 5000, 'No apareció el campo pass.').sendKeys('',webdriver.Key.ENTER);    
driver.sleep(2000);
...
// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_login/login_script_caso3/evidencia_1',  currentDateTime, 
'Error en screenshot para página de Login.'));

// Botón Aceptar
helpers.getVisibleElementWaiting(driver, By.xpath("//button[contains(.,'Aceptar')]"), 7000, 'No apareció la pagina principal.').click();

// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_login/login_script_caso3/evidencia_2',  currentDateTime, 
'Error en screenshot para página de Login.'));
