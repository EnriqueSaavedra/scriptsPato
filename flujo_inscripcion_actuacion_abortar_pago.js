// SCRIPT FLUJO INCRIPCION ACTUACION ABORTAR PAGO//
...
//log.init(driver, "C:/Selenium_test/scripts/logs/log_flujo_inscripcion_actuacion/Log_FlujoInscripcion_AbortarPago", null);
...
// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_flujos_inscripcion/flujo_inscripcion_actuacion_abortar_pago/evidencia_1',  currentDateTime, 
...
// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_flujos_inscripcion/flujo_inscripcion_actuacion_abortar_pago/evidencia_2',  currentDateTime, 
'Error en screenshot para página de Login.'));
...
driver.findElement(By.xpath("//div[contains(text(),'Revisar Actuacion')]"), 5000, 'No se encontró actuación.').click();
...
// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_flujos_inscripcion/flujo_inscripcion_actuacion_abortar_pago/evidencia_3',  currentDateTime, 
'Error en screenshot para página de Login.'));
...
// Click en actuación (chrome).
//driver.findElement(By.xpath("//div[contains(text(),'125512')]")).then(function(elem){
//driver.actions().doubleClick(elem).perform();
//});
//driver.sleep(3000);
...
// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_flujos_inscripcion/flujo_inscripcion_actuacion_abortar_pago/evidencia_4',  currentDateTime, 
'Error en screenshot para página de Login.'));
...
//elemento.sendKeys("C:\\Users\\PRG19HP\\Downloads\\m2.xml");
//driver.sleep(2000);

// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_flujos_inscripcion/flujo_inscripcion_actuacion_abortar_pago/evidencia_5',  currentDateTime, 
'Error en screenshot para página de Login.'));
...
// Click en botón abortar pago
driver.findElement(By.xpath("//button[contains(.,'Abortar Pago')]")).click();
driver.sleep(3000);

// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_flujos_inscripcion/flujo_inscripcion_actuacion_abortar_pago/evidencia_6',  currentDateTime, 
'Error en screenshot para página de Login.'));

// Click en botón si mensaje Se ha abortado el pago. Ahora puede repagar la actuación. 
helpers.getVisibleElementWaiting(driver, By.xpath("//button[contains(.,'Aceptar')]"), 5000, 'No aparece boton aceptar.').click();
driver.sleep(3000);

// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_flujos_inscripcion/flujo_inscripcion_actuacion_abortar_pago/evidencia_7',  currentDateTime, 
'Error en screenshot para página de Login.'));

// Click en actuación (mozilla)
//helpers.doubleClick(driver, 'xpath', '//div[contains(text(),"125002")]');
//driver.sleep(3000);

// Click en actuación 
driver.findElement(By.xpath("//div[contains(text(),"+numeroRepertorioNotaria+")]")).click();

// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_flujos_inscripcion/flujo_inscripcion_actuacion_abortar_pago/evidencia_8',  currentDateTime, 
'Error en screenshot para página de Login.'));
