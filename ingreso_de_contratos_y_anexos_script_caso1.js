// INGRESO_DE_CONTRATOS_Y_ANEXOS CASO1 //
...
driver.sleep(3000);
driver.findElement(By.css('#contrato-file-file')).sendKeys(datos[1].contrato);
driver.findElement(By.xpath("//button[contains(.,'Subir Contrato')]")).click();

// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_ingreso_de_contratos_y_anexos/ingreso_de_contratos_y_anexos_script_caso1/evidencia_1',  currentDateTime, 
