// INGRESAR__CONTRATANTE_ACREEDOR_SCRIPT_CASO9 //
...
// Inicio del Test
//var currentDateTime = helpers.getCurrentDateTime();
//console.log('Iniciando la ejecución del test en fecha: ' + currentDateTime + ' Ejecución: script_caso10_acreedor');
...
// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_ingresar_contratantes_acreedor/ingresar_contratante_acreedor_script_caso9/evidencia_1',  currentDateTime, 
...
// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_ingresar_contratantes_acreedor/ingresar_contratante_acreedor_script_caso9/evidencia_2',  currentDateTime, 
'Error en screenshot para página de Login.'));
...
// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_ingresar_contratantes_acreedor/ingresar_contratante_acreedor_script_caso9/evidencia_3',  currentDateTime, 
'Error en screenshot para página de Login.'));
...
//driver.findElement(By.xpath("//div[contains(text(),'PRAGMA S.A.')]"), 5000, 'No se encontró registro guardado.').click();
driver.findElement(By.xpath("//div[contains(text(),' ')]"), 5000, 'No se encontró registro guardado.').click();

// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_ingresar_contratantes_acreedor/ingresar_contratante_acreedor_script_caso9/evidencia_4',  currentDateTime, 
'Error en screenshot para página de Login.'));
