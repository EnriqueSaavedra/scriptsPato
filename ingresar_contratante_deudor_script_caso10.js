// INGRESAR__CONTRATANTE_DEUDOR_SCRIPT_CASO10 //
...
// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_ingresar_contratantes_deudor/ingresar_contratante_deudor_script_caso10/evidencia_1',  currentDateTime, 
...
// Validar agregar el segundo deudor
helpers.getVisibleElementWaiting(driver, By.className('x-grid3-row x-grid3-row-alt x-grid3-row-last'), 5000, 'Fallo al agregar deudor.');
