// INGRESAR__CONTRATANTE_CONSTITUYENTE_SCRIPT_CASO9 //
...
// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_ingresar_contratantes_constituyente/ingresar_contratante_constituyente_script_caso9/evidencia_1',  currentDateTime, 
'Error en screenshot para página de Login.'));

// Verificación de datos persona natural
helpers.getVisibleElementWaiting(driver, By.className('x-grid3-row x-grid3-row-first x-grid3-row-last'), 5000, 'Fallo al agregar constituyente.');
