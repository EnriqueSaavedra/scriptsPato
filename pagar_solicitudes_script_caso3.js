...
//log.init(driver, "C:/Selenium_test/scripts/logs/log_pagar_solicitudes/Log_PagarSolicitudes", null);
...
var datos = require('./datos_pagar_solicitudes.json');
...
// Validar la actualización de estado pagar actualización.
driver.sleep(3000);
driver.findElement(By.xpath("//div[contains(text(),"+numeroRepertorioNotaria+")]"), 5000, 'No se encontró actuación.').click();
...
// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_pagar_solicitudes/pagar_solicitudes_script_caso3/evidencia_1',  currentDateTime, 
...
// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_pagar_solicitudes/pagar_solicitudes_script_caso3/evidencia_2',  currentDateTime, 
'Error en screenshot para página de Login.'));
...
// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_pagar_solicitudes/pagar_solicitudes_script_caso3/evidencia_3',  currentDateTime, 
'Error en screenshot para página de Login.'));
...
// Validar existencia de actuación.
//driver.findElement(By.xpath("//div[contains(text(),'Pendiente')]"), 5000, 'No se encontró actuación.').click();
