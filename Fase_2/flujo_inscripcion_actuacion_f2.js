...
log.init(driver, "C:/Selenium_test/scripts/logs/LogAllLog", null);
log.info("------------------------------------------------------------------------------------");
log.info('Iniciando ejecución script ' + helpers.getFilename(__filename));

// Leer datos de prueba
var datos = require('./datos_inscripcion_actuacion_f2.json');
...
// Campo Usuario
helpers.getVisibleElementWaiting(driver, By.id('user'), 10000, 'No apareció el campo user.').sendKeys(datos[8].user2);

// Campo Password
helpers.getVisibleElementWaiting(driver, By.id('pass'), 10000, 'No apareció el campo pass.').sendKeys(datos[8].pass2, webdriver.Key.TAB);    
driver.sleep(2000);
...
// Botón terminar
driver.sleep(5000);
driver.findElement(By.xpath("//button[contains(.,'Terminar')]")).click();

// Buscar actuación en estado vigente
driver.sleep(3000);
driver.findElement(By.id('BUSCAR_ACTUACION_UP')).click();

// Combo tipo
driver.sleep(2000);
driver.findElement(By.id('tipoBusqueda')).click();
inputField = driver.findElement(By.css('div.x-combo-list-item:nth-child(2)')).click();

// Ingresar repertorio notaria
driver.sleep(3000);
driver.findElement(By.id('repertorioNotaria')).sendKeys(numeroRepertorioNotaria, webdriver.Key.TAB);
driver.sleep(2000);
