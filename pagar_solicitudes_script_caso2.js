...
// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_pagar_solicitudes/pagar_solicitudes_script_caso2/evidencia_1',  currentDateTime, 
...
// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_pagar_solicitudes/pagar_solicitudes_script_caso2/evidencia_2',  currentDateTime, 
'Error en screenshot para página de Login.'));
...
// Click en actuación (mozilla)
helpers.doubleClick(driver, 'xpath', '//div[contains(text(),"Pagar Actuacion")]');
driver.sleep(3000);
