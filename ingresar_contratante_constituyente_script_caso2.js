// INGRESAR__CONTRATANTE_CONSTITUYENTE_SCRIPT_CASO2 //
...
// Inicio del Test
//var currentDateTime = helpers.getCurrentDateTime();
//console.log('Iniciando la ejecución del test en fecha: ' + currentDateTime + ' Ejecución: script_caso2_constituyente');
...
// Ingresar Rut
driver.findElement(By.name('identificador')).sendKeys(datos[2].rut, webdriver.Key.TAB);
driver.sleep(2000);

// Ingresar Nombre 
driver.findElement(By.name('nombres')).sendKeys(datos[2].nombres, webdriver.Key.TAB); 
driver.sleep(2000);

// Ingresar Apellido paterno
driver.findElement(By.name('apellidoPaterno')).sendKeys(datos[2].apellidoPaterno, webdriver.Key.TAB);
driver.sleep(2000);

// Ingresar Apellido materno
driver.findElement(By.name('apellidoMaterno')).sendKeys(datos[2].apellidoMaterno, webdriver.Key.TAB);
driver.sleep(2000);
...
// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_ingresar_contratantes_constituyente/ingresar_contratante_constituyente_script_caso2/evidencia_1',  currentDateTime, 
