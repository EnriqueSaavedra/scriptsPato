...
// Inicio del Test
//var currentDateTime = helpers.getCurrentDateTime();
//console.log('Iniciando la ejecución del test en fecha: ' + currentDateTime + ' Ejecución: enviar_firma_caso1');
...
// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_enviar_firma/enviar_firma_script_caso1/evidencia_1',  currentDateTime, 
'Error en screenshot para página de Login.'));

// Click en botón No
driver.sleep(5000);
helpers.getVisibleElementWaiting(driver, By.xpath("//button[contains(.,'No')]"), 5000, 'No apareció el botón NO.').click();
driver.sleep(3000);

// Tomar evidencia 
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_enviar_firma/enviar_firma_script_caso1/evidencia_2',  currentDateTime, 
'Error en screenshot para página de Login.'));

// Validar cancelación de envío a firma
helpers.getVisibleElementWaiting(driver, By.xpath('//*[@id="ext-gen180"]'), 5000, 'No fue posible cancelar el envío a firma.').click();
