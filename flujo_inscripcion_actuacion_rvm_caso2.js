// SCRIPT FLUJO INCRIPCION ACTUACION RVM_CASO2 //
...
// Ingresar PPU
driver.findElement(By.name('new_ppu')).sendKeys(datos[7].ppu, webdriver.Key.TAB);
driver.sleep(2000);
...
driver.findElement(By.xpath("//div[contains(text(),'XT0236')]"), 5000, 'No se encontró ppu en la tabla.');

// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_flujos_inscripcion_rvm/flujo_inscripcion_actuacion_rvm_caso2/evidencia_1',  currentDateTime, 
...
// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_flujos_inscripcion_rvm/flujo_inscripcion_actuacion_rvm_caso2/evidencia_2',  currentDateTime, 
'Error en screenshot para página de Login.'));
