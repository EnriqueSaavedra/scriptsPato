// SCRIPT FLUJO INCRIPCION ACTUACION RVM_CASO1 //
...
// Ingresar Rut
driver.findElement(By.xpath('//*[@id="ext-comp-1135"]')).sendKeys(datos[11].rut, webdriver.Key.TAB);
driver.sleep(2000);

// Ingresar Nombre 
driver.findElement(By.xpath('//*[@id="ext-comp-1136"]')).sendKeys(datos[11].nombres, webdriver.Key.TAB); 
driver.sleep(2000);

// Ingresar Apellido paterno
driver.findElement(By.xpath('//*[@id="ext-comp-1139"]')).sendKeys(datos[11].apellidoPaterno, webdriver.Key.TAB);
driver.sleep(2000);

// Ingresar Apellido materno
driver.findElement(By.xpath('//*[@id="ext-comp-1140"]')).sendKeys(datos[11].apellidoMaterno, webdriver.Key.TAB);
driver.sleep(2000);
...
// Ingresar Rut
driver.findElement(By.xpath('//*[@id="ext-comp-1149"]')).sendKeys(datos[11].rut, webdriver.Key.TAB);
driver.sleep(2000);

// Ingresar Nombre 
driver.findElement(By.xpath('//*[@id="ext-comp-1150"]')).sendKeys(datos[11].nombres, webdriver.Key.TAB); 
driver.sleep(2000);

// Ingresar Apellido paterno
driver.findElement(By.xpath('//*[@id="ext-comp-1153"]')).sendKeys(datos[11].apellidoPaterno, webdriver.Key.TAB);
driver.sleep(2000);

// Ingresar Apellido materno
driver.findElement(By.xpath('//*[@id="ext-comp-1154"]')).sendKeys(datos[11].apellidoMaterno, webdriver.Key.TAB);
driver.sleep(2000);
...
// Ingresar PPU
driver.findElement(By.name('new_ppu')).sendKeys(datos[12].ppu, webdriver.Key.TAB);
driver.sleep(2000);
...
driver.findElement(By.xpath("//div[contains(text(),'UV0761')]"), 5000, 'No se encontró ppu en la tabla.');
...
// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_flujos_inscripcion_rvm/flujo_inscripcion_actuacion_rvm_caso1/evidencia_2',  currentDateTime, 
'Error en screenshot para página de Login.'));
...
// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_flujos_inscripcion_rvm/flujo_inscripcion_actuacion_rvm_caso1/evidencia_3',  currentDateTime, 
'Error en screenshot para página de Login.'));

// Click en botón si mensaje se encontró el/los RUN del constituyente en el contrato. ¿Desea enviar a firma de todas maneras?
driver.sleep(5000);
helpers.getVisibleElementWaiting(driver, By.xpath('//*[@id="ext-gen584"]'), 5000, 'No es posible realizar la acción.').click();
driver.sleep(5000);
...
//driver.findElement(By.xpath("//div[contains(text(),'123516')]")).then(function(elem){
...
driver.sleep(3000);
driver.findElement(By.xpath("//div[contains(text(),'"+numeroRepertorioNotaria+"')]"), 5000, 'No se encontró actuación en estado pagar actuación.').click();
driver.sleep(3000);

// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_flujos_inscripcion_rvm/flujo_inscripcion_actuacion_rvm_caso1/evidencia_4',  currentDateTime, 
'Error en screenshot para página de Login.'));
...
// Click en actuación (chrome)
//driver.findElement(By.xpath("//div[contains(text(),'Pagar Actuacion')]")).then(function(elem){
//driver.actions().doubleClick(elem).perform();
//});
//driver.sleep(3000);
...
// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_flujos_inscripcion_rvm/flujo_inscripcion_actuacion_rvm_caso1/evidencia_5',  currentDateTime, 
'Error en screenshot para página de Login.'));
...
elemento.sendKeys(datos[13].m2);
driver.sleep(2000);

// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_flujos_inscripcion_rvm/flujo_inscripcion_actuacion_rvm_caso1/evidencia_6',  currentDateTime, 
'Error en screenshot para página de Login.'));
...
// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_flujos_inscripcion_rvm/flujo_inscripcion_actuacion_rvm_caso1/evidencia_7',  currentDateTime, 
'Error en screenshot para página de Login.'));
