// INGRESAR__ANTECEDENTES_SCRIPT_CASO2 //
...
// Inicio del Test
//var currentDateTime = helpers.getCurrentDateTime();
//console.log('Iniciando la ejecución del test en fecha: ' + currentDateTime + ' Ejecución: ingresar_antecedentes_script_caso2');
...
driver.findElement(By.xpath('/html/body/div[11]/div/div[1]')).click();

// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_ingresar_antecedentes/ingresar_antecedentes_script_caso2/evidencia_1',  currentDateTime, 
'Error en screenshot para página de Login.'));

// validar
helpers.getVisibleElementWaiting(driver, By.xpath('//*[@id="ext-gen284"]'), 5000, 'Fallo la validación de fecha otorgamiento.'); 	
helpers.getVisibleElementWaiting(driver, By.xpath('//*[@id="ext-gen288"]'), 5000, 'Fallo la validación de fecha suscripción.'); 
driver.sleep(1000);
