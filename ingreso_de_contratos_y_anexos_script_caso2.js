// INGRESO_DE_CONTRATOS_Y_ANEXOS CASO2 //
...
// Inicio del Test
//var currentDateTime = helpers.getCurrentDateTime();
//console.log('Iniciando la ejecución del test en fecha: ' + currentDateTime + ' Ejecución: ingreso_de_contratos_y_anexos_script_caso1');
...
driver.sleep(3000);
driver.findElement(By.css('#contrato-file-file')).sendKeys(datos[2].contrato);
//driver.findElement(By.id('contrato-file-file')).sendKeys('C:\\Users\\PRG19HP\\Downloads\\SRPSD Manual de Usuario Oficinas de Atencion Integral 1.3.pdf');
driver.findElement(By.xpath("//button[contains(.,'Subir Contrato')]")).click();
driver.sleep(10000);

// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_ingreso_de_contratos_y_anexos/ingreso_de_contratos_y_anexos_script_caso2/evidencia_1',  currentDateTime, 
'Error en screenshot para página de Login.'));

// validar subida de archivo
helpers.getVisibleElementWaiting(driver, By.className('x-form-invalid-icon'), 5000, 'Error al cargar archivo de contrato.').click();
