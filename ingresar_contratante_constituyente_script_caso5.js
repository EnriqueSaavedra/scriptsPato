// INGRESAR__CONTRATANTE_CONSTITUYENTE_SCRIPT_CASO5 //
...
// Inicio del Test
//var currentDateTime = helpers.getCurrentDateTime();
//console.log('Iniciando la ejecución del test en fecha: ' + currentDateTime + ' Ejecución: script_caso6_constituyente');
...
// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_ingresar_contratantes_constituyente/ingresar_contratante_constituyente_script_caso5/evidencia_1',  currentDateTime, 
