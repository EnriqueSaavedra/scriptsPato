// INGRESAR__CONTRATANTE_DEUDOR_SCRIPT_CASO6 //
...
// Inicio del Test
//var currentDateTime = helpers.getCurrentDateTime();
//console.log('Iniciando la ejecución del test en fecha: ' + currentDateTime + ' Ejecución: script_caso7_deudor');
...
// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_ingresar_contratantes_deudor/ingresar_contratante_deudor_script_caso6/evidencia_1',  currentDateTime, 
...
//helpers.getVisibleElementWaiting(driver, By.className('x-form-text x-form-field credencial'), 5000, 'Pestaña acreedor: Fallo la validación de RUT persona jurídica.');
