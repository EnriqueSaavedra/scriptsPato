// INGRESAR__CONTRATANTE_CONSTITUYENTE_SCRIPT_CASO10 //
...
// Inicio del Test
//var currentDateTime = helpers.getCurrentDateTime();
//console.log('Iniciando la ejecución del test en fecha: ' + currentDateTime + ' Ejecución: script_caso11_constituyente');
...
// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_ingresar_contratantes_constituyente/ingresar_contratante_constituyente_script_caso10/evidencia_1',  currentDateTime, 
...
// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_ingresar_contratantes_constituyente/ingresar_contratante_constituyente_script_caso10/evidencia_2',  currentDateTime, 
'Error en screenshot para página de Login.'));

// Validar tabla constituyentes
helpers.getVisibleElementWaiting(driver, By.className('x-grid3-row x-grid3-row-alt x-grid3-row-last'), 5000, 'Fallo la validación de RUT persona jurídica.');
