// INGRESAR ANOTACIONES AL RVM CASO 3 //
...
// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_ingresar_antecedentes_anotaciones_rvm/ingresar_antecedentes_anotaciones_RVM_script_caso3/evidencia_1',  currentDateTime, 
...
driver.findElement(By.xpath("//div[contains(text(),'XT0237')]"), 5000, 'No se encontró ppu.').click();
driver.sleep(2000);

// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_ingresar_antecedentes_anotaciones_rvm/ingresar_antecedentes_anotaciones_RVM_script_caso3/evidencia_2',  currentDateTime, 
'Error en screenshot para página de Login.'));

// Actualizar PPU
driver.findElement(By.name('new_ppu')).clear();
driver.findElement(By.name('new_ppu')).sendKeys(datos[4].ppu, webdriver.Key.TAB);
driver.sleep(2000);
...
// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_ingresar_antecedentes_anotaciones_rvm/ingresar_antecedentes_anotaciones_RVM_script_caso3/evidencia_3',  currentDateTime, 
'Error en screenshot para página de Login.'));

// Validar actualización de ppu // 
helpers.getVisibleElementWaiting(driver, By.className('x-form-text x-form-field x-form-invalid'), 5000, 'Error de actualización ppu.');
//helpers.getVisibleElementWaiting(driver, By.className('x-form-text x-form-field'), 5000, 'Error de actualización ppu.');
