...
// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_firma_solicitudes/firma_solicitudes_script_caso1/evidencia_1',  currentDateTime, 
...
// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_firma_solicitudes/firma_solicitudes_script_caso1/evidencia_2',  currentDateTime, 
'Error en screenshot para página de Login.'));
...
//driver.findElement(By.xpath("//div[contains(text(),'123062')]")).then(function(elem){
...
// Click en botón si mensaje Por favor, confirme la eliminación de la solicitud.
...
// Validar que no exista la actuación eliminada
helpers.checkNotExistsElement(driver, By.xpath("//div[contains(text(),"+numeroRepertorioNotaria+")]"), 5000, 'Fallo eliminación de la actuación.');
