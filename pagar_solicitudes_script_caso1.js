...
// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_pagar_solicitudes/pagar_solicitudes_script_caso1/evidencia_1',  currentDateTime, 
...
// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_pagar_solicitudes/pagar_solicitudes_script_caso1/evidencia_2',  currentDateTime, 
'Error en screenshot para página de Login.'));
...
// Click en actuación (chrome)
//driver.findElement(By.xpath("//div[contains(text(),'124032')]")).then(function(elem){
//driver.actions().doubleClick(elem).perform();
//});
//driver.sleep(5000);
...
// Click en si en mensaje Por favor, confirme la eliminación de la solicitud.
driver.findElement(By.xpath('//*[@id="ext-gen498"]')).click();
driver.sleep(5000);

// Click en aceptar en mensaje Se ha eliminado la solicitud.
driver.findElement(By.xpath("//button[contains(.,'Aceptar')]")).click();
driver.sleep(5000);

// Validar la actualización de estado pagar actualización
helpers.checkNotExistsElement(driver, By.xpath("//div[contains(text(),'"+numeroRepertorioNotaria+"')]"), 5000, 'Pagar solicitud: Fallo la eliminación de la actuación.');
