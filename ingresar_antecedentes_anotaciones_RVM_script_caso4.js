// INGRESAR ANOTACIONES AL RVM CASO 4 //
...
// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_ingresar_antecedentes_anotaciones_rvm/ingresar_antecedentes_anotaciones_RVM_script_caso4/evidencia_1',  currentDateTime, 
...
// Click en botón eliminar ppu
driver.findElement(By.xpath("//button[contains(.,'Eliminar PPU(s)')]")).click();
driver.sleep(2000);

// Validar eliminación de ppu en tabla de ppu // 
helpers.checkNotExistsElement(driver, By.xpath("//div[contains(text(),'XT0237')]"), 5000, 'No se pudo eliminar ppu.');
