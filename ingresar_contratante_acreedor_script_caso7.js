// INGRESAR__CONTRATANTE_ACREEDOR_SCRIPT_CASO7 //
...
// Inicio del Test
//var currentDateTime = helpers.getCurrentDateTime();
//console.log('Iniciando la ejecución del test en fecha: ' + currentDateTime + ' Ejecución: script_caso8_acreedor');
...
// Campo identificador
driver.findElement(By.name('identificador')).sendKeys(datos[7].identificador, webdriver.Key.TAB); 
driver.sleep(2000); 

// Combobox Pais 
driver.findElement(By.xpath("//*[@id='ext-gen264']")).click();
inputField = driver.findElement(By.xpath('/html/body/div[13]/div/div[13]')).click();

// Campo nombre
driver.findElement(By.name('nombres')).sendKeys(datos[7].nombres, webdriver.Key.TAB);
driver.sleep(2000);

// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_ingresar_contratantes_acreedor/ingresar_contratante_acreedor_script_caso7/evidencia_1',  currentDateTime, 
...
// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_ingresar_contratantes_acreedor/ingresar_contratante_acreedor_script_caso7/evidencia_2',  currentDateTime, 
'Error en screenshot para página de Login.'));
