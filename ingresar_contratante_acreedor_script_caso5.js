// INGRESAR__CONTRATANTE_ACREEDOR_SCRIPT_CASO5 //
...
// Inicio del Test
//var currentDateTime = helpers.getCurrentDateTime();
//console.log('Iniciando la ejecución del test en fecha: ' + currentDateTime + ' Ejecución: script_caso6_acreedor');
...
// Ingresar Rut
driver.findElement(By.name('identificador')).sendKeys(datos[5].rut, webdriver.Key.TAB);
driver.sleep(2000);

// Ingresar razón social
driver.findElement(By.name('razonSocial')).sendKeys(datos[5].razonSocial, webdriver.Key.TAB);
driver.sleep(2000);
...
// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_ingresar_contratantes_acreedor/ingresar_contratante_acreedor_script_caso5/evidencia_1',  currentDateTime, 
