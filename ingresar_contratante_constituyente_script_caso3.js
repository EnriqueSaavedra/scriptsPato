// INGRESAR__CONTRATANTE_CONSTITUYENTE_SCRIPT_CASO3 //
...
// Inicio del Test
//var currentDateTime = helpers.getCurrentDateTime();
//console.log('Iniciando la ejecución del test en fecha: ' + currentDateTime + ' Ejecución: script_caso3_constituyente');
...
// Ingresar Rut
driver.findElement(By.name('identificador')).sendKeys(datos[3].rut, webdriver.Key.TAB);
driver.sleep(2000);

// Ingresar Nombre
driver.findElement(By.name('nombres')).sendKeys(datos[3].nombres, webdriver.Key.TAB); 
driver.sleep(2000);

// Ingresar Apellido paterno
driver.findElement(By.name('apellidoPaterno')).sendKeys(datos[3].apellidoPaterno, webdriver.Key.TAB);
driver.sleep(2000);

// Ingresar Apellido materno
driver.findElement(By.name('apellidoMaterno')).sendKeys(datos[3].apellidoMaterno, webdriver.Key.TAB);
driver.sleep(2000);

// Verificación de datos persona natural
helpers.getVisibleElementWaiting(driver, By.className('x-form-element remote-invalid-textfield'), 5000, 'Fallo la validación de persona natural.'); 	

// Click en botón agregar constituyente
driver.findElement(By.xpath("//button[contains(.,'Agregar Constituyente')]")).click();

// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_ingresar_contratantes_constituyente/ingresar_contratante_constituyente_script_caso3/evidencia_1',  currentDateTime, 
