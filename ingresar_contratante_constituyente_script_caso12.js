// SCRIPT CASO 12 INGRESAR__CONTRATANTE_CONSTITUYENTE_SCRIPT_CASO12 //
...
// Ingresar Rut
driver.findElement(By.name('identificador')).sendKeys(datos[6].rut, webdriver.Key.TAB);
driver.sleep(2000);

// Ingresar razón social
driver.findElement(By.name('razonSocial')).sendKeys(datos[6].razonSocial, webdriver.Key.TAB);
driver.sleep(2000);

// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_ingresar_contratantes_constituyente/ingresar_contratante_constituyente_script_caso12/evidencia_1',  currentDateTime, 
...
// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_ingresar_contratantes_constituyente/ingresar_contratante_constituyente_script_caso12/evidencia_2',  currentDateTime, 
'Error en screenshot para página de Login.'));
...
// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_ingresar_contratantes_constituyente/ingresar_contratante_constituyente_script_caso12/evidencia_3',  currentDateTime, 
'Error en screenshot para página de Login.'));
...
driver.findElement(By.xpath("//div[contains(text(),'PRAGMA INFORMATICA S.A.')]"), 5000, 'No se encontró registro guardado.').click();

// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_ingresar_contratantes_constituyente/ingresar_contratante_constituyente_script_caso12/evidencia_4',  currentDateTime, 
'Error en screenshot para página de Login.'));
