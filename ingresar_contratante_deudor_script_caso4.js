// INGRESAR__CONTRATANTE_DEUDOR_SCRIPT_CASO4 //
...
// Inicio del Test
//var currentDateTime = helpers.getCurrentDateTime();
//console.log('Iniciando la ejecución del test en fecha: ' + currentDateTime + ' Ejecución: script_caso5_deudor');
...
// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_ingresar_contratantes_deudor/ingresar_contratante_deudor_script_caso4/evidencia_1',  currentDateTime, 
'Error en screenshot para página de Login.'));

// Verificación de datos persona natural
helpers.checkNotExistsElement(driver, By.className('x-form-text x-form-field credencial x-form-invalid'), 5000, 'Fallo la validación de RUT persona jurídica.');
