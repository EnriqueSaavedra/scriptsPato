// SCRIPT CASO 13 INGRESAR__CONTRATANTE_CONSTITUYENTE //
...
// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_ingresar_contratantes_constituyente/ingresar_contratante_constituyente_script_caso13/evidencia_1',  currentDateTime, 
...
// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_ingresar_contratantes_constituyente/ingresar_contratante_constituyente_script_caso13/evidencia_2',  currentDateTime, 
'Error en screenshot para página de Login.'));

// Guardar y salir
driver.findElement(By.xpath("//button[contains(.,'Grabar y Salir')]")).click();
driver.sleep(5000);

// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_ingresar_contratantes_constituyente/ingresar_contratante_constituyente_script_caso13/evidencia_3',  currentDateTime, 
'Error en screenshot para página de Login.'));
driver.sleep(6000);
...
// Tomar evidencia
driver.takeScreenshot().then(helpers.saveImage('C:/Selenium_test/scripts/evidencias_pruebas/scripts_ingresar_contratantes_constituyente/ingresar_contratante_constituyente_script_caso13/evidencia_4',  currentDateTime, 
'Error en screenshot para página de Login.'));
